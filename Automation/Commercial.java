...
public class Commercial {
	...
	public static void main(String[] args) {
		...
		// Commercial Property
		driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div[3]/div[3]")).click();// Commercial
		...
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//div[@class='css-1hwfws3 nb-select__value-container nb-select__value-container--is-multi']")).click();//Apartment Type
